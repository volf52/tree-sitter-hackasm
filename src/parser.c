...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [27] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(5),
  [30] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(24),
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(24),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comp, 1),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dest, 1),
  [56] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comp, 1),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_c_inst, 2),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_c_inst, 2),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_a_inst, 2),
  [64] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_a_inst, 2),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label_def, 3),
  [68] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_label_def, 3),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_c_inst, 3),
  [72] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_c_inst, 3),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 1),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_jump, 1),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__jump_def, 2),
  [80] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__jump_def, 2),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label_ident, 1),
  [84] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_label_ident, 1),
